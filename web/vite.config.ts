...
/* === VARIABLES === */
// const repoName = "fusion-script-console"; // repo/project name (no leading /)
const appName = "Fusion Script Console"; // long app name
const shortName = "Fusion Console"; // short name (icon/menu)
const description =
  "Fusion 360 add-in UI with an API server for running Python scripts from a Svelte console";
